...
## 20. 案件資訊: 標案形式 field added, 契約模式 became a fixed dropdown, 每坪造價 computed
...
## 21. Calendar highlighted range now ends at 決選廠商, not a hardcoded deadline+14
...
## 22. Fixed dragged calendar events getting stuck at opacity-25 ("反白") after a successful move
